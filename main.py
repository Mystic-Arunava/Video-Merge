...
@MoviePremi1_bot.on_message(filters.private & filters.command("start"))
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Developer - @mystic_arunava", url="https://t.me/mystic_arunava")],
                [InlineKeyboardButton("Support Bot", url="https://t.me/MoviePremi1_bot"),
                 InlineKeyboardButton("Movie Channel", url="https://t.me/joinchat/hrZ5-P9O1eoxY2Y1")],
...
@MoviePremi1_bot.on_message(filters.private & (filters.video | filters.document) & ~filters.edited)
...
@MoviePremi1_bot.on_message(filters.private & filters.photo & ~filters.edited)
...
@MoviePremi1_bot.on_message(filters.private & filters.command("settings"))
...
@MoviePremi1_bot.on_message(filters.private & filters.command("broadcast") & filters.reply & filters.user(Config.BOT_OWNER) & ~filters.edited)
async def _broadcast(_, m: Message):
    await broadcast_handler(m)


@MoviePremi1_bot.on_message(filters.private & filters.command("status") & filters.user(Config.BOT_OWNER))
...
@MoviePremi1_bot.on_message(filters.private & filters.command("check") & filters.user(Config.BOT_OWNER))
...
@MoviePremi1_bot.on_callback_query()
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cb.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Bot](https://t.me/MoviePremi1_bot).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cb.message.edit(
                    text="Something went Wrong. Contact my [Support Bot](https://t.me/MoviePremi1_bot).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - @mystic_arunava", url="https://t.me/mystic_arunava"), InlineKeyboardButton("Support Bot", url="https://t.me/MoviePremi1_bot")], [InlineKeyboardButton("Movie Channel", url="https://t.me/joinchat/hrZ5-P9O1eoxY2Y1")]]),
            disable_web_page_preview=True
        )
        ...
        if (QueueDB.get(cb.from_user.id, None) is None) or (QueueDB.get(cb.from_user.id) == []):
            await cb.answer("Sorry Unkil, Your Queue is Empty!", show_alert=True)
            return
        merged_vid_path = f"{Config.DOWN_PATH}/{str(cb.from_user.id)}/[@mystic_arunava]_Merged.{FormtDB.get(cb.from_user.id).lower()}"
